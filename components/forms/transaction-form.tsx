...
import { ArrowUpIcon, ArrowDownIcon, CalendarIcon, CreditCardIcon, TagIcon, WalletIcon, RepeatIcon } from "@phosphor-icons/react"
...
export function TransactionForm() {
  ...
  const isFutureTransaction = selectedDate > today
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    addTransaction({
      ...
      status: isCreditCard || isFutureTransaction || recurrence !== "none" ? "pending" : "paid",
    })
      ...
      {cards.length > 0 && (
        <div className="space-y-2">
          <label className="text-sm font-medium text-foreground flex items-center gap-2">
            ...
            Cartão {isFutureTransaction ? "(opcional para futuras)" : ""}
          </label>
